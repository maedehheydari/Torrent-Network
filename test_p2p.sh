...
# Start Peer3 (will download files)
...
# Test Scenario 1: Peer3 downloads file1.txt from Peer1
echo -e "${GREEN}Test Scenario 1: Peer3 downloading file1.txt from Peer1${NC}"
sleep 5

# Test Scenario 2: Peer3 tries to download non-existent file
...
# Test Scenario 3: Peer3 downloads file2.txt from Peer2
...
# Test Scenario 4: Peer1 disconnects
echo -e "${GREEN}Test Scenario 4: Peer1 disconnecting${NC}"
pkill -f "python3.*Peer1"
sleep 5

# Test Scenario 5: Another peer tries to download file1.txt (should still work as Peer3 has it)
...
# Optional: Remove test directories and files
# rm -rf peer1_dir peer2_dir peer3_dir peer4_dir
